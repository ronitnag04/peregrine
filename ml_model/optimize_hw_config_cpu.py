#!/usr/bin/env python3
"""
Pareto-optimal hardware configuration search for Peregrine O3CPU (CPU version).
...
This version uses CPU instead of AWS Neuron/torch_xla.
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Pareto-optimal hardware configuration search (CPU version).")
...
def main() -> None:
    ...
    # Warm up with a single baseline config.
    t0 = time.perf_counter()
